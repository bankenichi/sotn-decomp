...
| `docs/loop-call-outcome-2026-09-16.md` | loop/call outcomes, historical tallies, the review's corrected diagnosis and implementation evidence, and remaining coverage limits |
