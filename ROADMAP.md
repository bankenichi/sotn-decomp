...
| 209 | done | Added and wired the read-only provenance-aware `model_codegen_audit.py`. Its preprocessor-branch-aware locator, explicit rename recovery and overlay include-graph selection resolve all 133 model-contributed matches. The live pass found 15 strong unusual shapes: 2 already explained and 13 requiring recovered compiler reasoning, now retained as #213 |
...
| 213 | **open** | Recover and record the codegen reason for the 13 model-contributed matches surfaced by #209 without rewriting their verified shapes: `SetSubStep`, `SetStep`, `func_801CE1E8`, `func_us_801BC3E0`, `func_us_801CC750_from_no0`, `EntityArmorLordFireWave`, `func_us_801AC54C`, `func_8018DC28`, `func_us_8019F9C0`, legacy queue name `func_us_801D1A9C_from_are`, `func_8018D8C8`, `func_us_8019F5F0`, and `EntityCorpseweed`. Use assembly, preserved candidates, queue evidence and commit history; add substantive `CODEGEN:` comments only where the evidence supports the exact constraint |
