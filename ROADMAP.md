...
## Codex transition and dependency audit, 2026-08-18 (#130 to #163)
...
| 163 | **open** | **NEXT:** Repair the seven legacy body-only candidate files reported by `test_permuter_seed.py`. Preserve each original in immutable history, reconstruct a self-contained current generation from its recorded origin or work directory, verify focused importability, and update its queue note to the exact immutable path before deterministic P2 work |
