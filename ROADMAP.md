...
| 238 | **reopened, partial** | The bounded Zen wave attempted ten of the original 22 todo records but incorrectly treated fleet ineligibility as terminal coverage and left twelve live `todo` records untouched. That completion claim is retracted. This task is the active gate: exhaust or durably reclassify all twelve records, preserving every candidate and failure receipt, before #239 or any later task advances. The remaining set is `func_us_801BB314`, `func_us_8019B5A4`, `func_us_8019C610`, `dma_execute`, `EntityShaft`, `func_us_801BC678`, `func_us_801AF604`, `func_us_801B619C`, `func_us_801D15C0`, `func_us_801ABD24`, `func_us_801AE858`, and RCHI `EntityBreakable`. The recovery snapshot and the ten prior outcomes remain valid; only the false terminal status is retracted |
