...
| 305 | **open** | Expand scorer calibration beyond the first two real function families, add independent lineage groups and measure an improvement before recommending new default weights. The #304 production tuner and later-run consumption are complete, but its three bounded configurations tied and are exploratory evidence only. Keep holdout separate from selection and preserve the initial reports. |
