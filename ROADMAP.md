...
The scope expansion invalidated the old terminal assumption, but it did not
erase the older lanes. Finish the open ledger in this order:

1. #254 and #255 are complete. Execute #242 through #249 in numeric order against their refreshed live
   populations. #250 is superseded because its 177-record boundary no longer
   describes the queue.
2. Complete the provenance-preserving upstream lane in #251 and the independent
   itemdefs evaluation in #252.
3. Classify the 512 new todo records once in #256, then exhaust the bounded
   overlay waves #257 through #264 in order. Every wave begins with upstream,
   shared-header, twin, and transplant evidence before model or permuter work.
4. Run the new whole-queue terminal audit in #265.
