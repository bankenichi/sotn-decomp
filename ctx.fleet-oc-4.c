...
void DecelerateX(s32 deceleration) {
    ...
    if (velocityX < 0) {
        newVelocityX = deceleration + velocityX;
        g_CurrentEntity->velocityX = newVelocityX;
        if (newVelocityX > 0) {
            g_CurrentEntity->velocityX = 0;
        }
    } else {
        newVelocityX_2 = velocityX - deceleration;
...
void DecelerateY(s32 deceleration) {
    ...
    if (velocityY < 0) {
        newVelocityY = deceleration + velocityY;
        g_CurrentEntity->velocityY = newVelocityY;
        if (newVelocityY > 0) {
            g_CurrentEntity->velocityY = 0;
        }
    } else {
        newVelocityY_2 = velocityY - deceleration;
...
void func_us_801B9ACC(s32 speed) {
    s32 signedSpeed;
    signedSpeed = speed;
    if (g_Entities[64].entityRoomIndex == 1) {
        signedSpeed = -signedSpeed;
    }
...
void BO6_RicSetInvincibilityFrames(s32 kind, s16 invincibilityFrames) {
    if (!kind) {
        BO6_RicCreateEntFactoryFromEntity(
            g_CurrentEntity, ((BP_CRASH_DAGGER) + (0x15 << 16)), 0);
...
void func_us_801B9C14(void) {
    g_Entities[64 + E_AFTERIMAGE_1].ext.afterImage.timer = 0;
    g_Entities[64 + E_AFTERIMAGE_1].ext.afterImage.index = 0;
    g_Entities[64 + E_AFTERIMAGE_1].ext.afterImage.resetFlag = 0;
    g_Entities[64 + E_AFTERIMAGE_1].ext.afterImage.disableFlag = 0;
}
...
void BO6_RicSetSlideKick(void) {
    ...
    g_CurrentEntity->velocityY = ((s32)((-2) * 65536.0));
    BO6_RicSetSpeedX(((s32)((5.5) * 65536.0)));
    func_us_801B9C14();
...
Entity* BO6_RicCreateEntFactoryFromEntity(
    ...
    Entity* entity =
        BO6_RicGetFreeEntity(64 + 4, 64 + 16);
    if (!entity) {
        return (0);
    }
