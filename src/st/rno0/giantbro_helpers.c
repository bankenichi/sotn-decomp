...
// Everything from func_801CE04C onward now lives in unk_4A320.c, matching the
// upstream file boundary: src/st/giantbro_helpers.h ends here, and no2/4966C.c
// and np3/4E04C.c begin at func_801CE04C.
