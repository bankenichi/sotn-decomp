...
| Automation | 155 Python modules, 65 test suites plus 36 modules with their own `--self-test`, 99 connector tools, 104 diagnostics |
...
| transplant | 135 | 31% | transplant.py moved a twin body in mechanically |
