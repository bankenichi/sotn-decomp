...
DIAGNOSTICS = [
    ...
    ("Model codegen audit", "model_codegen_audit.py", "",
     "model-contributed matches with unusual C and no compiler reasoning"),
    ("Artifact store self-test", "artifact_store.py", "--self-test",
     "immutable generations and atomic stable-view publication"),
