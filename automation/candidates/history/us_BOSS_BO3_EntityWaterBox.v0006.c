/* UPSTREAM CANDIDATE -- complete target translation unit.
   ...
   record : us:BOSS/BO3:EntityWaterBox
   upstream: upstream/master
   source : d5e5165b67cf38746ee7f56eb3e420f7067ecdd6:src/st/no4/first_c_file.c
...
void func_us_801C2B78_from_no4(Entity* self) {
    ...
    while (prim != NULL) {
        if (prim->drawMode != DRAW_HIDE) {
            ...
            var_s2 = 0;
            if (LOW(prim->r2) < 0) {
                // CODEGEN: Preserve the target's empty negative-velocity branch.
            } else {
                var_s2 = 1;
            }
