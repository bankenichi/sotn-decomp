...
s16 func_801904B8(Entity* arg0, s16 arg1) {
    ...
    posXHi = g_CurrentEntity->posX.i.hi;
    val = posXHi - 8;
    arg0->rotPivotX = val;
    ((s16*)&arg0->velocityX)[0] = val;

    posXHi = g_CurrentEntity->posX.i.hi;
    paletteVal = arg1 + 0x20;

    arg0->step_s = arg1;
    arg0->rotPivotY = arg1;

    ((u8*)&arg0->params)[1] = 0x26;
    ((u8*)&arg0->zPriority)[1] = 0x26;
    arg0->drawFlags = 6;
    ((u8*)&arg0->velocityY)[1] = 6;
    arg0->palette = paletteVal;
    ((s16*)&arg0->velocityX)[1] = paletteVal;

    val = posXHi + 8;
    arg0->step = val;
    arg0->facingLeft = val;

    if ((s16)paletteVal >= 0x101) {
        paletteVal = 0;
    }
