/* PERMUTER SEED -- deterministic isolated-score candidate.
   record : us:BOSS/RBO1:polarPlacePartsList
   score  : 5
   receipt: nonmatchings/.adapt-scores/20260824-233559-62298-123194/polarPlacePartsList/adapt-score.json
   producer: compiled-donor transplant, no model
   content: WHOLE FILE (isolated adaptable draft)
   origin : src/boss/rbo1/unk_12274.c
   asm    : asm/us/boss/rbo1/nonmatchings/unk_12274/polarPlacePartsList.s
