/* PERMUTER SEED -- legacy compiling body reconstructed as a whole file.
   ...
   asm    : boss/bo6/matchings/richter
...
extern int BO6_RicMain();
extern int func_us_801B8E80();
extern int rcos();
extern int rsin();
extern int BO6_CheckBladeDashInput();
extern int func_us_801BA9D0();
extern int abs();
extern int FntPrint();
extern int BO6_RicSetInvincibilityFrames();
extern int InitializeEntity();
extern int BO6_DisableAfterImage();
extern int func_us_801BBBD0();
extern int BO6_RicSetFall();
