/* PERMUTER SEED -- deterministic isolated-score candidate.
   ...
   score  : 10
   receipt: nonmatchings/.adapt-scores/20260824-235046-62298-424607/EntityGearSidewaysSmall/adapt-score.json
   producer: compiled-donor transplant, no model
   content: WHOLE FILE (isolated adaptable draft)
   origin : src/st/rnz1/unk_276A8.c
   asm    : asm/us/st/rnz1/nonmatchings/unk_276A8/EntityGearSidewaysSmall.s
...
extern EInit g_EInitEnvironment;
extern Point16 D_us_80180FC8[2];
