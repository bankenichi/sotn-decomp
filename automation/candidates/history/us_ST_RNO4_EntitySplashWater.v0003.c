/* PERMUTER SEED -- deterministic isolated-score candidate.
   ...
   score  : 15
   receipt: nonmatchings/.adapt-scores/20260824-234707-62298-430787/EntitySplashWater/adapt-score.json
   producer: compiled-donor transplant, no model
   content: WHOLE FILE (isolated adaptable draft)
   origin : src/st/rno4/unk_52ED0.c
   asm    : asm/us/st/rno4/nonmatchings/unk_52ED0/EntitySplashWater.s
...
void EntitySplashWater(Entity* self) {
    ...
    case 0:
        ...
        g_api_PlaySfxVolPan(D_us_80180E58[0], 0x7F, aspect);

        self->velocityY = -D_us_80182230[params * 2];
        self->ext.waterEffects.accelY = D_us_80182230[params * 2 + 1];
