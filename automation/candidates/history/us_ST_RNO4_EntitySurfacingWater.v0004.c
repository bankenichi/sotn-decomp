/* PERMUTER SEED -- deterministic isolated-score candidate.
   ...
   score  : 10
   receipt: nonmatchings/.adapt-scores/20260824-234712-62298-055222/EntitySurfacingWater/adapt-score.json
   producer: compiled-donor transplant, no model
   content: WHOLE FILE (isolated adaptable draft)
   origin : src/st/rno4/unk_52ED0.c
   asm    : asm/us/st/rno4/nonmatchings/unk_52ED0/EntitySurfacingWater.s
...
void EntitySurfacingWater(Entity* self) {
    ...
    case 0:
        ...
        self->ext.waterEffects.topY.i.hi =
            -(D_us_80182250[self->params & 0xFF] + 12 + (rand() & 1));
    ...
    i = self->velocityX;
    if (i != 0) {
        x = g_Tilemap.width - D_us_80180E5C[self->ext.waterEffects.unk88] -
            D_us_80180E5C[self->ext.waterEffects.unk88 + 1];
        if (i < 0) {
            ...
            x += (D_us_80180E5C[self->ext.waterEffects.unk88 + 1] - 6 -
