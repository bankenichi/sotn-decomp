/* PERMUTER SEED -- deterministic isolated-score candidate.
   ...
   score  : 5
   receipt: nonmatchings/.adapt-scores/20260824-233436-62298-251336/EntityDemonSwitchWall/adapt-score.json
   producer: compiled-donor transplant, no model
   content: WHOLE FILE (isolated adaptable draft)
   origin : src/boss/bo7/e_demon_switch_wall.c
   asm    : asm/us/boss/bo7/nonmatchings/e_demon_switch_wall/EntityDemonSwitchWall.s
...
#define PRIM_TILE 1
#define SFX_WALL_DEBRIS_B 1604
extern s16 D_us_801805F0[24];
extern EInit D_us_80180454;
...
void EntityDemonSwitchWall(Entity* self) {
    ...
    case IDLE_CLOSED:  
        ...
        break;
    case PREP_TO_OPEN:  
        primIdx = g_api_AllocPrimitives(PRIM_TILE, 16);
        if (primIdx != -1) {
