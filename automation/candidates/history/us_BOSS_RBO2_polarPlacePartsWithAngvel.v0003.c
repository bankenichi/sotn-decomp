/* PERMUTER SEED -- deterministic isolated-score candidate.
   record : us:BOSS/RBO2:polarPlacePartsWithAngvel
   score  : 5
   receipt: nonmatchings/.adapt-scores/20260824-233637-62298-472770/polarPlacePartsWithAngvel/adapt-score.json
   producer: compiled-donor transplant, no model
   content: WHOLE FILE (isolated adaptable draft)
   origin : src/boss/rbo2/unk_1B284.c
   asm    : asm/us/boss/rbo2/nonmatchings/unk_1B284/polarPlacePartsWithAngvel.s
