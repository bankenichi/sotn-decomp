/* ADVANCED RECONCILIATION #232 -- direct allocator call hypothesis.
   Derived mechanically from immutable v0003; unverified until isolated score.
...
void BO6_RicEntityCrashBibleBeam(Entity* self) {
    ...
    case 0:
        ...
        self->primIndex =
            g_api_AllocPrimitives(PRIM_G4, BO6_BIBLE_PAGE_COUNT);
        if (self->primIndex == -1) {
            DestroyEntity(self);
            return;
        }
