/* PERMUTER SEED -- compiled and linked, bytes differ.
   ...
   asm    : asm/us/boss/bo0/nonmatchings/3053C/func_us_801B1C60.s
...
s32 func_us_801B1C60(Entity* arg0) {
    s32 temp_s0;
    void* temp_s1;

    temp_s1 = (void*)arg0->blendMode;
    func_us_801B163C((u8*)&g_CurrentEntity->ext.venusWeedFlower + 0x14, -0x100, 0xC);
    temp_s0 = func_us_801B171C(arg0, -0x1C0, 0x280, 0x10);
    return (temp_s0 + func_us_801B171C(temp_s1, -0x380, 0x140, 0x10)) == 2;
}
