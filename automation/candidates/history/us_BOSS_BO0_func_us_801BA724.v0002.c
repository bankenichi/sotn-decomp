/* PERMUTER SEED -- compiled and linked, bytes differ.
   record : us:BOSS/BO0:func_us_801BA724
   attempt: 2/4
   ...
   import : python3 tools/decomp-permuter/import.py <this file> asm/us/boss/bo0/nonmatchings/2D26C/func_us_801BA724.s
...
void func_us_801BA724(Entity* entity) {
    Primitive* prim;
    DRAWENV draw;
    s16 primIndex;
    s16 tpage;
    ...
    case 0:
        ...
        entity->ext.prim = &g_PrimBuf[primIndex];
