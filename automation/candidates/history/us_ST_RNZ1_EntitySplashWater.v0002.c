/* PERMUTER SEED -- deterministic isolated-score candidate.
   record : us:ST/RNZ1:EntitySplashWater
   score  : 15
   receipt: nonmatchings/.adapt-scores/20260824-235131-62298-648446/EntitySplashWater/adapt-score.json
   producer: compiled-donor transplant, no model
   content: WHOLE FILE (isolated adaptable draft)
   origin : src/st/rnz1/unk_37BF8.c
   asm    : asm/us/st/rnz1/nonmatchings/unk_37BF8/EntitySplashWater.s
...
extern s16 g_splashAspects[8];
extern s32 D_us_80181E88[8];
...
void EntitySplashWater(Entity* self) {
    ...
    case 0:
        ...
        g_api_PlaySfxVolPan(D_us_8018105C[0], 0x7F, aspect);

        self->velocityY = -D_us_80181E88[params * 2];
        self->ext.waterEffects.accelY = D_us_80181E88[params * 2 + 1];
