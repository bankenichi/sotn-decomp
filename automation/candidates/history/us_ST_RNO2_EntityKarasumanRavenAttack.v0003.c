/* PERMUTER SEED -- deterministic isolated-score candidate.
   record : us:ST/RNO2:EntityKarasumanRavenAttack
   score  : 5
   receipt: nonmatchings/.adapt-scores/20260824-234315-62298-968897/EntityKarasumanRavenAttack/adapt-score.json
   producer: compiled-donor transplant, no model
   content: WHOLE FILE (isolated adaptable draft)
   origin : src/st/rno2/unk_439A4.c
   asm    : asm/us/st/rno2/nonmatchings/unk_439A4/EntityKarasumanRavenAttack.s
