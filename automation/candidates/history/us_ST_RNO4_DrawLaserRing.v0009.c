/* PERMUTER SEED -- compiled and linked, bytes differ.
   ...
   asm    : asm/us/st/rno4/nonmatchings/unk_58A30/DrawLaserRing.s
...
/* Declarations injected by the worker: used by the candidate
   ...
   tree, same overlay or a shared header, never another
   overlay's. */
extern s32 D_us_80182B4C[]; /* retained ST/RNO4 data asm/us/st/rno4/data/2210.data.s, size 0x8 */
extern s32 D_us_80182B54[]; /* retained ST/RNO4 data asm/us/st/rno4/data/2210.data.s, size 0x8 */
extern s32 D_us_80182B5C[]; /* retained ST/RNO4 data asm/us/st/rno4/data/2210.data.s, size 0x8 */
extern s32 D_us_80182B64[]; /* retained ST/RNO4 data asm/us/st/rno4/data/2210.data.s, size 0x8 */
