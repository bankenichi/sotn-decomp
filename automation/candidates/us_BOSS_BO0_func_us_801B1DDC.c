/* PERMUTER SEED -- compiled and linked, bytes differ.
   ...
   import : python3 tools/decomp-permuter/import.py <this file> asm/us/boss/bo0/nonmatchings/2D26C/func_us_801B1DDC.s
...
s32 func_us_801B1DDC(Entity* arg0) {
    Entity* temp_s1;
    s32 temp_s0;

    temp_s1 = arg0->blendMode;
    func_us_801B163C(&g_CurrentEntity->ext.venusWeed.triggerAttack, 0, 0xC);
    temp_s0 = func_us_801B171C(arg0, -0x2C0, 0x2C0, 0x28);
    return (temp_s0 + func_us_801B171C(temp_s1, -0x100, 0x3C0, 0x38)) == 2;
}
