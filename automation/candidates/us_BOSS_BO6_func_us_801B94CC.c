/* PERMUTER SEED -- deterministic isolated-score candidate.
   ...
   score  : 2245
   receipt: nonmatchings/.adapt-scores/20260824-195232-1994-222876/func_us_801B94CC/adapt-score.json
   producer: compiled-donor transplant, no model
   content: WHOLE FILE (isolated adaptable draft)
   origin : src/boss/bo6/us_39144.c
   asm    : asm/us/boss/bo6/nonmatchings/us_39144/func_us_801B94CC.s
...
extern int BO6_RicResetPose();
extern int entityUpdate();
