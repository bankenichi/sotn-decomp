...
s32 func_us_801B1C60(Entity* arg0) {
    ...
    blendMode = arg0->blendMode;
    func_us_801B163C(&((u8*)g_CurrentEntity)[0x90], -0x100, 0xC);
    result1 = func_us_801B171C(arg0, -0x1C0, 0x280, 0x10);
    result2 = func_us_801B171C((void*)blendMode, -0x380, 0x140, 0x10);
