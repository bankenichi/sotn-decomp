...
def load_target_index(
    ...
    for raw in raw_records:
        ...
        header_contexts = tuple(archive.verify(ArtifactRef.from_dict(entry["input"]))
                                for entry in context_evidence.get("header_siblings", ()) or ())
        inline["declarations"] = renderer_declarations(target_doc.get("declarations", {}), assembly_bytes, context_bytes, sibling_contexts, header_contexts)
