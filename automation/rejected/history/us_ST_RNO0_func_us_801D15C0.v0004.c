...
extern s32 D_us_80183310[]; /* retained ST/RNO0 data asm/us/st/rno0/data/32B4.data.s, size 0x10 */
extern s32 D_us_8018332C[]; /* retained ST/RNO0 data asm/us/st/rno0/data/32B4.data.s, size 0x10 */

/* Mechanical symbol repair from escalation_triage.py. */
extern Entity g_Entities_224[];

/* Mechanical symbol repair from escalation_triage.py. */
extern s32 D_us_80183320[]; /* retained ST/RNO0 data asm/us/st/rno0/data/32B4.data.s, size 0xc */
