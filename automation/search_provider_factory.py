...
def prepare_provider_inputs(repo, lanes, targets, lane_inputs, *, indexed_runtime=None, target_declarations=None):
    ...
    for recipient, (assembly, _) in targets.items():
        ...
        prepared[recipient] = {
            "seed": seed, "seed_origin": seed_origin, "declarations": {key: value for key, value in declarations.items() if key not in {"call_declarations", "api_declarations", "data_declarations", "pointer_layouts", "type_declarations"}},
