...
AUTOMATION_SCRIPTS = {
    ...
    "test_search_frontier.py",
    "test_search_historical_fixture.py",
    "test_search_ledger.py",
    "test_search_lanes.py",
    "test_search_mutations.py",
    "test_search_permuter_vendor.py",
    ...
    "test_compiler_corpus.py",
    "test_compiler_idioms.py",
    "test_draft_landed_miner.py",
